...
//////////////////////////////////////////////////////////////////////////////
package opennlp.tools14.chunker;
...
import opennlp.tools14.util.BeamSearch;
...
public class ChunkerME implements Chunker {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    GISModel mod;
    opennlp.maxent25.EventStream es;
    if (encoding != null) {
       es = new ChunkerEventStream(new opennlp.maxent25.PlainTextByLineDataStream(new InputStreamReader(new FileInputStream(inFile),encoding)));
    }
    else {
      es = new ChunkerEventStream(new opennlp.maxent25.PlainTextByLineDataStream(new java.io.FileReader(inFile)));
    }
    mod = train(es, iterations, cutoff);
    System.out.println("Saving the model as: " + args[1]);
    new opennlp.maxent25.io.SuffixSensitiveGISModelWriter(mod, outFile).persist();
  }
}
