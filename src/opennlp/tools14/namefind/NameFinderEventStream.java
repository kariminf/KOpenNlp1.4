...
public class NameFinderEventStream implements EventStream {
  ...
  public static final void main(String[] args) throws java.io.IOException {
    ...
    EventStream es = new NameFinderEventStream(new NameSampleDataStream(new opennlp.maxent25.PlainTextByLineDataStream(new java.io.InputStreamReader(System.in))));
    while (es.hasNext()) {
