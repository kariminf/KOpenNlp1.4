...
//////////////////////////////////////////////////////////////////////////////   
package opennlp.tools14.parser.chunking;
...
import opennlp.tools14.ngram.NGramModel;
import opennlp.tools14.ngram.Token;
...
public class Parser extends AbstractBottomUpParser {
  ...
  public static void main(String[] args) throws java.io.IOException, InvalidFormatException {
    ...
    if (dict || all) {
      ...
      DataStream data = new opennlp.maxent25.PlainTextByLineDataStream(new java.io.FileReader(inFile));
    ...
    if (build || all) {
      ...
      opennlp.maxent25.EventStream bes = new ParserEventStream(new opennlp.maxent25.PlainTextByLineDataStream(new java.io.FileReader(inFile)), rules, ParserEventTypeEnum.BUILD,tridict);
    ...
    if (check || all) {
      ...
      opennlp.maxent25.EventStream kes = new ParserEventStream(new opennlp.maxent25.PlainTextByLineDataStream(new java.io.FileReader(inFile)), rules, ParserEventTypeEnum.CHECK);
