...
public abstract class AbstractMentionFinder implements MentionFinder {
  ...
  private void collectCoordinatedNounPhraseMentions(Parse np, List entities) {
    ...
    for (Iterator sci = sc.iterator();sci.hasNext();) {
      ...
      String type = scp.getSyntacticType();
      if (type.equals("UCP") || type.equals("NX") || type.equals("ADJP")) {
        return;
      }
    }
  ...
  public Mention[] getMentions(Parse p) {
    //System.err.println("getMentions: before get noun phrases");
    List nps = p.getNounPhrases();
    //System.err.println("getMentions: after get noun phrases "+nps.size());
    Collections.sort(nps);
    //System.err.println("getMentions: after sort");
    Map headMap = constructHeadMap(nps);
    //System.err.println("getMentions: after construct head map");
    ...
    //System.err.println("getMentions: after collect mentions");
    return mentions;
  }
