...
import opennlp.tools14.lang.english.NameFinder;
import opennlp.tools14.parser.Parse;
import opennlp.tools14.parser.chunking.Parser;
import opennlp.tools14.util.Span;

/**
 * This class is a wrapper for {@link opennlp.tools14.parser.Parse} mapping it to the API specified in {@link opennlp.tools14.coref.mention.Parse}.
...
public class DefaultParse extends AbstractParse {
  ...
  public opennlp.tools14.coref.mention.Parse getParent() {
    Parse parent = parse.getParent();
    if (parent == null) {
      return null;
    }
  ...
  public opennlp.tools14.coref.mention.Parse getPreviousToken() {
    Parse parent = parse.getParent();
    Parse node = parse;
    int index=-1;
  ...
  public opennlp.tools14.coref.mention.Parse getNextToken() {
    Parse parent = parse.getParent();
    Parse node = parse;
    int index=-1;
