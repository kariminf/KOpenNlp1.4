...
import opennlp.maxent25.io.PooledGISModelReader;
import opennlp.tools14.namefind.NameFinderEventStream;
import opennlp.tools14.namefind.NameFinderME;
import opennlp.tools14.parser.Parse;
import opennlp.tools14.tokenize.SimpleTokenizer;
...
public class NameFinder {
  ...
  private static void processText(NameFinder[] finders, String[] tags, BufferedReader input) throws IOException {
    ...
    opennlp.tools14.tokenize.Tokenizer tokenizer = new SimpleTokenizer();
