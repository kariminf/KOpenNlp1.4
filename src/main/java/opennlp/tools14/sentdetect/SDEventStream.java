...
public class SDEventStream implements EventStream {
    ...
    public SDEventStream(DataStream d) {
      this(d,new opennlp.tools14.lang.english.EndOfSentenceScanner(), new DefaultSDContextGenerator(opennlp.tools14.lang.english.EndOfSentenceScanner.eosCharacters));
    }
    ...
    public static void main(String[] args) throws IOException {
      ...
      if (lang == null || lang.equals("english") || lang.equals("spanish")) {
        ...
        cg = new opennlp.tools14.lang.thai.SentenceContextGenerator();
      }
      else {
        usage();
      }
