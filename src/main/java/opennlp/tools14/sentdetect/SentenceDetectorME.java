...
package opennlp.tools14.sentdetect;
...
import opennlp.maxent25.GIS;
import opennlp.maxent25.GISModel;
import opennlp.maxent25.IntegerPool;
...
public class SentenceDetectorME implements SentenceDetector {
  ...
  public SentenceDetectorME(MaxentModel m) {
    this(m, new DefaultSDContextGenerator(opennlp.tools14.lang.english.EndOfSentenceScanner.eosCharacters), new opennlp.tools14.lang.english.EndOfSentenceScanner());
  }
  ...
  public SentenceDetectorME(MaxentModel m, SDContextGenerator cg) {
    this(m, cg, new opennlp.tools14.lang.english.EndOfSentenceScanner());
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      if (lang == null || lang.equals("english") || lang.equals("spanish")) {
        scanner = new opennlp.tools14.lang.english.EndOfSentenceScanner();
        cg = new DefaultSDContextGenerator(scanner.getEndOfSentenceCharacters());
      }
      else if (lang.equals("thai")) {
        scanner = new opennlp.tools14.lang.thai.EndOfSentenceScanner();
