...
//////////////////////////////////////////////////////////////////////////////
package opennlp.tools14.namefind;
...
public class NameFinderME implements TokenNameFinder {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    if (encoding != null) {
       es = new NameFinderEventStream(new NameSampleDataStream(new opennlp.maxent25.PlainTextByLineDataStream(new InputStreamReader(new FileInputStream(inFile),encoding))));
    }
    else {
      es = new NameFinderEventStream(new NameSampleDataStream(new opennlp.maxent25.PlainTextByLineDataStream(new java.io.FileReader(inFile))));
    }
