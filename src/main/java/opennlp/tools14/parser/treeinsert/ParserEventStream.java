...
import opennlp.tools14.parser.AbstractParserEventStream;
...
public class ParserEventStream extends AbstractParserEventStream {
  ...
  */
  ...
  public static void main(String[] args) throws java.io.IOException, InvalidFormatException {
    ...
    HeadRules rules = new opennlp.tools14.lang.english.HeadRules(args[ai++]);
    if (fun) {
      Parse.useFunctionTags(true);
    }
    opennlp.maxent25.EventStream es = new ParserEventStream(new opennlp.maxent25.PlainTextByLineDataStream(new java.io.InputStreamReader(System.in)), rules, etype, dict);
    while (es.hasNext()) {
