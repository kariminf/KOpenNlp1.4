...
package opennlp.tools14.tokenize;
...
import opennlp.tools14.lang.english.TokenStream;
...
//  }
  ...
  public static GISModel train(EventStream evc, int iterations, int cutoff) throws IOException {
    return opennlp.maxent25.GIS.trainModel(iterations, new TwoPassDataIndexer(evc, cutoff));
  }
